var  expect = require('expect.js'),
    sinon = require('sinon'),
    Labels = require('../index'),
    Item = require('achart-plot').Item,
    ShowLabels = require('../index').ShowLabels,
    $ = require('jquery'),
...
describe('show labels',function(){
  ...
  Util.mixin(A,[ShowLabels]);
  $('<div id="s3"></div>').appendTo('body');
  ...
  a.renderLabels();
  var labelsGroup = a.get('labelsGroup')
  it('create',function(){
  ...
  it('remove',function(){
    a.removeLabels();
   // expect(labelsGroup.getCount()).to.be(0);
